...
def data_pipeline(
    ...
    # All the configs needed by config.py    
    ...
    if os.path.exists(x_train_path) and \
       ...
       os.path.exists(y_test_path):
        ...
        mlflow_tracker.log_data_pipeline_metrics({'total_samples': len(X_train)+len(X_test),
    ...
    if not os.path.exists('temp_imputed.csv'):
        ...
        # temporary solution to running gender imputation again and again all the time
    ...
    min_max_strategy = MinMaxScalingStratergy()
