...
data-pipeline:
	...
	.venv\Scripts\activate.bat && $(PYTHON) pipelines/data_pipeline.py

# Run training pipeline
train-pipeline:
	@echo Running training pipeline...
	.venv\Scripts\activate.bat && $(PYTHON) pipelines/training_pipeline.py

# Run streaming inference pipeline with sample JSON
streaming-inference:
	@echo Running streaming inference pipeline with sample JSON...
	.venv\Scripts\activate.bat && $(PYTHON) pipelines/streaming_inference_pipeline.py
